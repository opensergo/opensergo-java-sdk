...
@javax.annotation.Generated(
    ...
    comments = "Source: specification/proto/servicecontract.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class MetadataServiceGrpc {

  private MetadataServiceGrpc() {}

  public static final String SERVICE_NAME = "opensergo.api.MetadataService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.alibaba.opensergo.api.proto.ReportMetadataRequest,
      com.alibaba.opensergo.api.proto.ReportMetadataReply> getReportMetadataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReportMetadata",
      requestType = com.alibaba.opensergo.api.proto.ReportMetadataRequest.class,
      responseType = com.alibaba.opensergo.api.proto.ReportMetadataReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.alibaba.opensergo.api.proto.ReportMetadataRequest,
      com.alibaba.opensergo.api.proto.ReportMetadataReply> getReportMetadataMethod() {
    io.grpc.MethodDescriptor<com.alibaba.opensergo.api.proto.ReportMetadataRequest, com.alibaba.opensergo.api.proto.ReportMetadataReply> getReportMetadataMethod;
      ...
      synchronized (MetadataServiceGrpc.class) {
        if ((getReportMetadataMethod = MetadataServiceGrpc.getReportMetadataMethod) == null) {
          MetadataServiceGrpc.getReportMetadataMethod = getReportMetadataMethod =
              io.grpc.MethodDescriptor.<com.alibaba.opensergo.api.proto.ReportMetadataRequest, com.alibaba.opensergo.api.proto.ReportMetadataReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReportMetadata"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.alibaba.opensergo.api.proto.ReportMetadataRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.alibaba.opensergo.api.proto.ReportMetadataReply.getDefaultInstance()))
  ...
  public static abstract class MetadataServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void reportMetadata(com.alibaba.opensergo.api.proto.ReportMetadataRequest request,
        io.grpc.stub.StreamObserver<com.alibaba.opensergo.api.proto.ReportMetadataReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.alibaba.opensergo.api.proto.ReportMetadataRequest,
                com.alibaba.opensergo.api.proto.ReportMetadataReply>(
  ...
  public static final class MetadataServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MetadataServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.alibaba.opensergo.api.proto.ReportMetadataReply reportMetadata(com.alibaba.opensergo.api.proto.ReportMetadataRequest request) {
  ...
  public static final class MetadataServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MetadataServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.alibaba.opensergo.api.proto.ReportMetadataReply> reportMetadata(
        com.alibaba.opensergo.api.proto.ReportMetadataRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REPORT_METADATA:
          serviceImpl.reportMetadata((com.alibaba.opensergo.api.proto.ReportMetadataRequest) request,
              (io.grpc.stub.StreamObserver<com.alibaba.opensergo.api.proto.ReportMetadataReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MetadataServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.alibaba.opensergo.api.proto.Servicecontract.getDescriptor();
    }
